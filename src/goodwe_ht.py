...
goodwe_ht_parameters: dict[str, Parameter] = {
    ...
    "Status 1": Parameter(
        addr=32002, count=1, dtype=DataType.U16, multiplier=1, unit="",
        device_class=DeviceClass.ENUM,
        register_type=RegisterTypes.INPUT_REGISTER
    ),

    # PV String Voltages and Currents (Registers 32016-32063)
    # Note: HT series supports up to 24 PV strings
    # All PV measurements are S16 (signed) per protocol specification
    ...
    "Input DC Power": Parameter(
        addr=32064, count=2, dtype=DataType.I32, multiplier=1000, unit="kW",
    ...
    "Peak Active Power": Parameter(
        addr=32078, count=2, dtype=DataType.I32, multiplier=1000, unit="kW",
        device_class=DeviceClass.POWER,
        register_type=RegisterTypes.INPUT_REGISTER
    ),
    ...
    "Efficiency": Parameter(
        addr=32086, count=1, dtype=DataType.U16, multiplier=100, unit="%",
        device_class=DeviceClass.POWER_FACTOR,
        register_type=RegisterTypes.INPUT_REGISTER
    ),
    ...
    "Internal Temperature": Parameter(
        addr=32087, count=1, dtype=DataType.I16, multiplier=10, unit="°C",
    ...
    "Monthly Energy": Parameter(
        addr=32116, count=2, dtype=DataType.U32, multiplier=100, unit="kWh",
        device_class=DeviceClass.ENERGY,
        register_type=RegisterTypes.INPUT_REGISTER
    ),
    "Yearly Energy": Parameter(
        addr=32118, count=2, dtype=DataType.U32, multiplier=100, unit="kWh",
        device_class=DeviceClass.ENERGY,
        register_type=RegisterTypes.INPUT_REGISTER
    ),
    ...
    "Model": Parameter(
        addr=35510, count=8, dtype=DataType.UTF8, multiplier=1, unit="",
        device_class=DeviceClass.ENUM,
        register_type=RegisterTypes.INPUT_REGISTER
    ),
    ...
    "DSP1 Version": Parameter(
        addr=35515, count=1, dtype=DataType.U16, multiplier=1, unit="",
        device_class=DeviceClass.ENUM,
        register_type=RegisterTypes.INPUT_REGISTER
    ),
    "DSP2 Version": Parameter(
        addr=35516, count=1, dtype=DataType.U16, multiplier=1, unit="",
        device_class=DeviceClass.ENUM,
        register_type=RegisterTypes.INPUT_REGISTER
    ),
    ...
    "DC Bus Voltage": Parameter(
        addr=35753, count=1, dtype=DataType.U16, multiplier=10, unit="V",
        device_class=DeviceClass.VOLTAGE,
        register_type=RegisterTypes.INPUT_REGISTER
    ),
    ...
    "ISO Value": Parameter(
        addr=35757, count=1, dtype=DataType.U16, multiplier=10, unit="k©",
        device_class=DeviceClass.ENUM,
        register_type=RegisterTypes.INPUT_REGISTER
    ),
    ...
    "Status 2": Parameter(
        addr=37207, count=1, dtype=DataType.U16, multiplier=1, unit="",
        device_class=DeviceClass.ENUM,
        register_type=RegisterTypes.INPUT_REGISTER
    ),
}
